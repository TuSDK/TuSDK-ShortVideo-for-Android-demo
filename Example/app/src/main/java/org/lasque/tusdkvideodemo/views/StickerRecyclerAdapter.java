...
public class StickerRecyclerAdapter extends RecyclerView.Adapter<StickerRecyclerAdapter.StickerViewHolder>
    ...
    public void onBindViewHolder(StickerViewHolder stickerViewHolder, final int position) {
        ...
        if(isContains){
            ...
            Glide.with(mContext).load(model.getPreviewNamePath()).into(stickerViewHolder.mItemImage);
        ...
        if(position == mCurrentPosition){
            stickerViewHolder.mItemWarp.setBackground(TuSdkContext.getDrawable(R.drawable.sticker_cell_background));
        }else{
        ...
        if(position == mCurrentLongPos && isContains && position == mCurrentLongPos){
            stickerViewHolder.mItemWarp.setBackground(TuSdkContext.getDrawable(R.drawable.sticker_cell_remove_background));
            ...
            public void onClick(View v) {
                ...
                if (mStickerDownloader.isDownloaded(itemData.groupId)) {
                    if(mCurrentLongPos == position){
                        ...
                        if (listener != null && mCurrentPosition != position) listener.onItemClick(position);
                    }
                } else {
    ...
    class StickerViewHolder extends RecyclerView.ViewHolder{
        ...
        public StickerViewHolder(View itemView) {
            ...
            mDownStateImage = itemView.findViewById(R.id.lsq_item_state_image);
            mItemWarp = itemView.findViewById(R.id.lsq_item_wrap);
            mRemoveStickerImage = itemView.findViewById(R.id.lsq_item_remove);
        }
    }
}
