...
public class SceneEffectsTimelineView extends EffectsTimelineView<SceneEffectsTimelineView.SceneEffectModel>
{
    /**
     ...
     * 场景特效信息
     */
    public static class SceneEffectModel extends TuSDKMediaSceneEffectData implements EffectsTimelineView.EffectModelInterface
    {
        private int mColor;
