...
public class MagicEffectsTimelineView extends EffectsTimelineView<MagicEffectsTimelineView.MagicEffectModel>
{
    /**
     ...
     */
    public static class MagicEffectModel extends TuSDKMediaParticleEffectData implements EffectsTimelineView.EffectModelInterface
    {
        private int mColor;
