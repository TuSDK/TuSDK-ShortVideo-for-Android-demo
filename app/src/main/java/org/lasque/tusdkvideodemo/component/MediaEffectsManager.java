...
public class MediaEffectsManager
{
    ...
    private List<SceneEffectsTimelineView.SceneEffectModel> mSceneEffectDataList = new ArrayList<>();

    // 魔法特效 TuSDKMediaParticleEffectData （支持添加多个）
    private List<MagicEffectsTimelineView.MagicEffectModel> mMagicEffectDataList = new ArrayList<>();
     ...
     */
    public void setSceneEffectDataList(List<SceneEffectsTimelineView.SceneEffectModel> sceneEffectDataList) {
     ...
     */
    public void setMagicEffectDataList(List<MagicEffectsTimelineView.MagicEffectModel> magicEffectDataList) {
